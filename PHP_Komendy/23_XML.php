...
#Przykład 2 - SimpleXML

/**
Napisz stronę pokazującą listę zajęć na uniwersytecie, korzystając z danych w pliku xml/uwm.xml. Skorzystaj z SimpleXML.
Wypisz tytuł kursu, prowadzącego oraz godzinę rozpoczęcia kursu:
...
$xml = simplexml_load_file('xml/uwm.xml');

$courses = $xml->xpath('course_listing');
$counter = 1;

foreach ($courses as $course) {
    echo "$counter: ";
    echo "Kurs: ". $course->title . ", ";
    echo "Prowadzący: " . $course->section_listing->instructor . ", ";
    echo "Godzina rozpoczęcia:" . $course->section_listing->hours->start . "<br>";
    $counter ++;
}
